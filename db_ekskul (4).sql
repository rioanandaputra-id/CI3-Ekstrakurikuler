...
--
-- Host: 127.0.0.1
-- Generation Time: 20 Mar 2021 pada 01.56
...
--
ALTER TABLE `tbl_ekskul_gallery`
  MODIFY `kode_ekskul_gallery` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
...
--
ALTER TABLE `tbl_ekskul_penilaian`
  MODIFY `kode_ekskul_penilaian` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tbl_ekskul_siswa`
--
ALTER TABLE `tbl_ekskul_siswa`
  MODIFY `kode_ekskul_siswa` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--

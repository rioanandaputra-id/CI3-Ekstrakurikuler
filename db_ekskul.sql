...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Apr 2021 pada 07.18
...
(1, 'SMK NEGERI 7 BANDAR LAMPUNG', '10301989', '4232322', 'JL. PRABOWO, S.Kom, M.Kom', 26175, '0751-190285', 'Linggar Jati', 'TANJUNG ', 'BANDAR LAMPUNG', 'LAMPUNG', 'SMK7NBDL.SCH.ID', 'smkn7bdl@gmail.com');
...
(30, 1, 'foto_gallery/20210320075204-WhatsApp Image 2021-03-17 at 01.28.59 (2).jpeg', '2021-03-20', 'qqqq222', ''),
(31, 2, 'foto_gallery/20210320075238-WhatsApp Image 2021-03-17 at 01.25.07.jpeg', '2021-03-26', 'wewe', ''),
(32, 1, 'foto_gallery/20210324113030-157-1578752_wi-fi-computer-icons-hotspot-wireless-signal-transparent.png', '2021-03-26', 'lomba pbb', '');
...
(9, 'lomba', 1, '2021-03-26', '2021-03-27', '2021-03-31', 'sekolah', 'lapangan', 'wqewq', 'file_lomba/20210320075452-Ajuan S29d Semester 2 MA Mathlaul Anwar Labuhan Ratu.xlsx');
...
(3, '123', '133', 'rifqi', 'foto_pegawai/20210320052640-WhatsApp Image 2021-03-17 at 01.25.07.jpeg', 'erer', '2021-03-20', 'pembina', '11@22.2', '21232f297a57a5a743894a0e4a801fc3', '3434', '32323', '3'),
(4, '24234', '234234', 'aziz', 'foto_pegawai/20210320062657-ok0.ts', '234324', '2021-03-20', 'guru', 'weqwe@32323.2323', 'd41d8cd98f00b204e9800998ecf8427e', 'wqeqwe', '2323', '2');
...
(23434, '2323', 'tubagus', '001', 'lampung', '2021-03-27', '001', '1', 'tubagus', '11@22.com', '8d5891b55ccb5f5809559d62af779ae306d2f39b23e0d2508a11e8140b049f003e4004e6f5189b5513d56c1ba75074f9efba4a02b7ab92db43496f426e46075e', '1', '3', 2020, 'foto_siswa/default.jpg'),
(23435, '123', 'ardhan', '001', '2222', '1997-06-03', '001', '0895391343399', 'ardhan', 'ardhan@gmail.com', 'd41d8cd98f00b204e9800998ecf8427e', 'jl. jalan', '3', 2020, 'foto_siswa/default.jpg'),
(23436, '4444', 'andi', '001', 'bandar lampung', '2002-06-27', '001', '0895391343399', 'andi', 'andi@gmail.com', 'ce0e5bf55e4f71749eade7a8b95c4e46', 'jl jalan', '3', 2021, 'foto_siswa/20210406132626-FOTO.jpg');
...
(56, '2', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 1, '11:16:00', '2021-03-24'),
(57, '2', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 1, '11:25:28', '2021-03-24'),
(58, '2', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 1, '11:31:48', '2021-03-24'),
(59, '2', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 1, '11:32:15', '2021-03-24'),
(60, '2', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 1, '11:33:33', '2021-03-24'),
(61, '2', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 1, '11:34:27', '2021-03-24'),
(62, '2', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 1, '11:37:27', '2021-03-24'),
(63, '3', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 3, '15:59:09', '2021-03-24'),
(64, '2', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 1, '13:17:36', '2021-04-06'),
(65, '2', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 1, '13:22:47', '2021-04-06'),
(66, '23436', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 0, '13:25:11', '2021-04-06'),
(67, '2', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 1, '13:28:40', '2021-04-06'),
(68, '3', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 3, '13:29:13', '2021-04-06'),
(69, '2', '::1', 'Chrome 87.0.4280.88', 'Windows 10', 1, '13:29:19', '2021-04-06');
...
--
ALTER TABLE `tbl_ekskul_gallery`
  MODIFY `kode_ekskul_gallery` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `tbl_ekskul_lomba`
  MODIFY `kode_ekskul_lomba` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT untuk tabel `tbl_ekskul_penilaian`
--
ALTER TABLE `tbl_ekskul_penilaian`
  MODIFY `kode_ekskul_penilaian` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `tbl_ekskul_siswa`
--
ALTER TABLE `tbl_ekskul_siswa`
  MODIFY `kode_ekskul_siswa` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `tbl_siswa`
  MODIFY `kode_siswa` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23437;
...
--
ALTER TABLE `users_aktivitas`
  MODIFY `id_users_aktivitas` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
COMMIT;
